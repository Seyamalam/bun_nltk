// Bundled RSLP rules from nltk_data/stemmers/rslp/step*.pt — do not edit.
export const RSLP_STEPS: string[] = [
`# Step 0: Plural Reduction
"ns"	1	"m"	*
"ões"	3	"ão"	*
"ães"	1	"ão"	"mãe"
"ais"	1	"al"	"cais","mais"
...
"mente"	4	""	"experimente"
`,
`# Step 3: Augmentative/Diminutive Reduction
"díssimo"	5	""	*
"abilíssimo"	5	""	*
"íssimo"	3	""	*
"ésimo"		3	""	*
