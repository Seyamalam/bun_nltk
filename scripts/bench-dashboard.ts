...
function main() {
  ...
  const dashboard = {
    ...
    parity: {
      ...
      tokenizer_family: Boolean(parityAll.checks?.tokenizer_family),
      ...
      stemmers: Boolean(parityAll.checks?.stemmers),
      translation_metrics: Boolean(parityAll.checks?.translation_metrics),
      sentiment: Boolean(parityAll.checks?.sentiment),
      lm: Boolean(parityAll.checks?.lm),
      chunk: Boolean(parityAll.checks?.chunk),
      wordnet: Boolean(parityAll.checks?.wordnet),
      wordnet_compat: Boolean(parityAll.checks?.wordnet_compat),
  ...
  const md = [
    ...
    `Parity tokenizer_family: ${dashboard.parity.tokenizer_family}`,
    ...
    `Parity stemmers: ${dashboard.parity.stemmers}`,
    `Parity translation_metrics: ${dashboard.parity.translation_metrics}`,
    `Parity sentiment: ${dashboard.parity.sentiment}`,
    `Parity lm: ${dashboard.parity.lm}`,
    `Parity chunk: ${dashboard.parity.chunk}`,
    `Parity wordnet: ${dashboard.parity.wordnet}`,
    `Parity wordnet_compat: ${dashboard.parity.wordnet_compat}`,
